import selectStories, { InvalidOptionError } from '../selectStories';
...
describe('selectStories', () => {
  ...
  describe('widths option', () => {
    ...
    it('rejects empty widths', () => {
      ...
      expect(() => selectStories(stories)).toThrow(
        new InvalidOptionError('Need at least one valid width'),
      );
    });
    ...
    it('rejects non-numeric widths', () => {
      ...
      expect(() => selectStories(stories)).toThrow(
        new InvalidOptionError("Given width 'x' is invalid"),
      );
    });
